...
public class SootInitializer {
	 ...
	 * not be read.
	 */
	public static InfoflowResults analyzeAPKFile(String apkFileName, String xmlFileName)
	 ...
	 * not be read.
	 */
	public static InfoflowResults analyzeAPKFile(String apkFileName, String xmlFileName, boolean enableImplicitFlows)
					throws IOException, XmlPullParserException {
